...
export function votingEventFixture(overrides = {}) {
  return {
    ...
    archivedAt: null,
    searchTitleNormalized: 'voting event',
    searchDescriptionNormalized: '',
    searchLocationNormalized: '',
    searchTitleGrams: ['voting', 'event'],
    searchDescriptionGrams: [],
    searchLocationGrams: [],
    searchGrams: ['voting', 'event'],
    categories: [{
    ...
    votingState: { status: 'open', version: 1, openedAt: new Date('2030-01-01T12:00:00.000Z'), closedAt: null,
      updatedAt: new Date('2030-01-01T12:00:00.000Z'), updatedByAccountId: votingTestIds.hostId },
    createdAt: new Date('2030-01-01T10:00:00.000Z'),
    updatedAt: new Date('2030-01-01T10:00:00.000Z'),
    schemaVersion: 5,
    ...overrides,
